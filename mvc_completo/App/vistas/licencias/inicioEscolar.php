...
<div class="container">
    ...
    <a onclick="history.back()" class="btn btn-light"><i class="bi bi-chevron-double-left"></i>Volver</a> 

    <div class="card bg-light">
        <h2 class="card-header">Añadir licencia escolar</h2>

        <form method="post" ENCTYPE="multipart/form-data" action="<?php echo RUTA_URL?>/Licencias/nueva_licencia" class="card-body">
            <div class="mt-3 mb-3">
                <label for="numlic">Número licencia (GIR): <sup>*</sup></label>
                <input type="text" name="numlic" id="numlic" class="form-control form-control-lg">
            </div>
            <div class="mb-3">
                <label for="dorsal">Dorsal (DEA): <sup>*</sup></label>
            ...
            <div class="mb-3">
                ...
                <input name="tipo" id="tipo" class="form-control form-control-lg" value="Escolar" readOnly>
            </div>
            <div class="mb-3">
