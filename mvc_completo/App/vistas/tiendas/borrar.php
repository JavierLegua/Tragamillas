...
<div class="card bg-light mt-5 w-75 card-center" style=" margin: auto;">
    ...
    <form method="post" class="card-body">
        <div class="mt-3 mb-3">
            ...
            <input type="text" name="nombre" id="nombre" class="form-control form-control-lg" value="<?php echo $datos['tienda']->apellidoUsuario ?>" disabled>
        </div>
        <div class="mb-3">
            <label for="email">Email: <sup>*</sup></label>
            <input type="email" name="email" id="email" class="form-control form-control-lg" value="<?php echo $datos['tienda']->email ?>" disabled>
        </div>
        <div class="mb-3">
